/** 
 * Implementacin de Algoritmos de Ordenacin.
 * @author Javier Galve
 * @since 6/02/2017
...
public class Ord
{
  ...
  /*
   * ACCIN ordenarBurbuja (Entero[] a)
   * EFECTO: Ordena a de manera creciente por el mtodo 
   *         de la burbuja.
   */
  public static void ordenarBurbuja (int[] a) { 
    for (int i=0; i<a.length; i++)
      // Poner en su sitio el elemento desordenado ms pequeo:
      burbujaArriba (a, i);
    // Encoger la parte desordenada del array 
    // (avanzando con la i).
  }
  /*
   * FUNCIN aString (Entero[] a)--> String
  ...
  //Mtodo de SELECCIN
  /*
   * FUNCIN posicionDelMinimo (Entero[], Natural inicio) --> Natural
   * PRE: longitud(a) >= 1
   * POST: Calcula la posicin del elemento ms pequeo del subarray 
  ...
  /*
   * ACCI�N ordenarSeleccion (Entero[] a)
   * EFECTO: Ordena a de manera creciente por el m�todo 
   *         de selecci�n.
   */
  ...
  //M�todo de INSERCI�N
  /*
   * FUNCI�N posicionDondePonerlo (Entero[] a, 
   *                               Natural fin, 
   *                               Natural valor) --> Natural
   * PRE: longitud(a[0..fin]) >= 1 /\ a[0..fin] est� ordenado 
   *      crecientemente
   * POST: Calcula la posici�n del primer elemento de "a[0..fin]" 
   *       mayor que "valor"
   */
  ...
  /*
   * ACCI�N ordenarInsercion (Entero[] a)
   * EFECTO: Ordena a de manera creciente por el m�todo 
   *         de inserci�n.
   */
