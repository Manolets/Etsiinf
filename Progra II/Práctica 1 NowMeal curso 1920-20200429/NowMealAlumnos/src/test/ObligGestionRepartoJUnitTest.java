...
public class ObligGestionRepartoJUnitTest {
	...
	public void testAsignarPedido() {
		...
		for (int i=0;i<NUM_IT;i++){
			...
			assertEquals("[Iteracion "+i+"] El gestor "+j+" no se actualiz� correctamente.", construirRespuestaEstadoGestor(i>0?0:1,0,i<1?0:i-1,0), gestor.getEstadoGestorLocalNum(j));

			gestor.asignarPedido(pedidosPequenos[i][j]);

			assertEquals("[Iteracion "+i+"] El gestor "+j+" no se actualiz� correctamente.", construirRespuestaEstadoGestor(0,0,i,0), gestor.getEstadoGestorLocalNum(j));
	...
	public void testNotificarEntregaPedido() throws PedidoSinTransporteAsignado {
		...
		for (int i=0;i<NUM_IT-1;i++){
			...
			assertEquals("[Iteracion "+i+"] El gestor "+j+" no se actualiz� correctamente.", construirRespuestaEstadoGestor(0,0,NUM_IT-2-i,0), gestor.getEstadoGestorLocalNum(j));

		}


		assertEquals("[Iteracion "+(NUM_IT-1)+"] El gestor "+j+" no se actualiz� correctamente.", construirRespuestaEstadoGestor(0,0,0,0), gestor.getEstadoGestorLocalNum(j));

		gestor.notificarEntregaPedido(pedidosPequenos[NUM_IT-1][j]);

		assertEquals("[Iteracion "+(NUM_IT-1)+"] El gestor "+j+" no se actualiz� correctamente.", construirRespuestaEstadoGestor(1,0,0,0), gestor.getEstadoGestorLocalNum(j));
