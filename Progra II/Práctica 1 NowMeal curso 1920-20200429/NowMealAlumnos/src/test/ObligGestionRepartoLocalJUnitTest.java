...
public class ObligGestionRepartoLocalJUnitTest {
	...
	/*
	 * Comprueba que se asigna la �nica moto disponible y que despu�s
	...
	public void testAsignarPedidoSoloUnaMoto() {
		...
		// Preparar transporte. Instanciar una �nica moto
		moto1 = new Moto("M1", mapa);
		mapa.addObjetoDinamico("M1", new PosicionXY(7,4));
		gestor.add(moto1);                // A�adir transporte
		gestor.asignarPedido(pedido);      // Asignar transporte para pedido
		...
		assertEquals("Transporte err�neamente asignado", moto1.getCodigo(), moto2.getCodigo());	
	...
	public void testAsignarPedidoVariasMotos() {
		...
		// Test4: Asignar transporte coste m�nimo. Hay dos motos disponibles
		...
		gestor.add(moto4);                // A�adir transporte
		gestor.add(moto3);                // A�adir transporte
		gestor.add(moto2);                // A�adir transporte		
		
		gestor.asignarPedido(pedido);      // Asignar transporte para pedido
		moto1 = (Moto) pedido.getTransporte();  // Obtener el transporte, supuestamente M2
		// Test4: transporte debe ser M2 por coste
		// Previamente pongo este assert para que si no asigna nada se d� informaci�n espec�fica
		assertNotEquals("Transporte no asignado (es null) cuando hay motos disponibles", moto1, null);
		assertEquals("El transporte asignado no es el de m�nimo coste", moto2.getCodigo(), moto1.getCodigo());
	...
	/*
	 * Comprueba la notificaci�n de la entrega de un pedido para moto
	 */
	@Test
	 ...
	 * y Pedido, y los m�todos asignarPedido</p>
	 * 
	 * <p>Se crea un pedido y se comprueba que se lanza la excepci�n
	...
	public void testNotificarEntregaPedido2() throws PedidoSinTransporteAsignado {
		...
		// Instanciar pedido
		pedido = new Pedido(cliente, comidasSolicitadas, restaurante);
		// como el pedido no tiene asignado transporte, deber�a lanzar
		// la excepci�n
		gestor.notificarEntregaPedido(pedido);
	}
